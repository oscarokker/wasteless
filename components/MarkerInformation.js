    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.bottomContent}>
                {/*<Image style={styles.wasteType} resizeMode="cover" source={wasteIcons["plasticIcon"]} />
                <Image style={styles.wasteType} resizeMode="cover" source={wasteIcons["cardboardIcon"]} />*/}
                {
                    wasteTypes.map((type, index) => {
                        const icon = wasteIcons[`${type}Icon`];
                        return icon ? (
                            <Image
                                key={index}
